...
20년간 시장을 봤다. 리먼도 코로나도 이 자리에서 겪었고, 그 이전 오일쇼크·블랙먼데이·IMF·닷컴의 폭락사는 기록으로 익혔다. 그 경험이 오늘 말해주는 건 하나다. **저 두 반사신경은 둘 다 틀렸다.** 그리고 왜 틀렸는지를 보여주는 게, 어느 쪽이 맞는지 찍어주는 것보다 훨씬 값이 있다.
