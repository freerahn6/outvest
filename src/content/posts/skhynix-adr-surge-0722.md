...
description: "간밤 뉴욕에서 SK하이닉스 ADR +13.75%, 샌디스크 +14.27%, 마이크론 +12.17%. 엔비디아는 +1.97%였다. 어제 우리 글의 가설과 방향이 같다. 그런데 같은 날 7월 1~20일 반도체 수출 +180.6%와 모건스탠리 메모리 가격 리포트가 함께 나왔다. 그리고 ADR-본주 괴리는 +38%(계산)로 벌어졌다."
pubDate: 2026-07-22
draft: false
